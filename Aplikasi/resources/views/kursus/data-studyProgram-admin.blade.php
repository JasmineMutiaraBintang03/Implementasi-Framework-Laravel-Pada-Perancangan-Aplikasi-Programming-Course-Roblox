                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="save-kursus" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label for="iduser">Materi Kursus</label>
                                            <textarea name="materi_kursus" id="materi_kursus" cols="30" rows="3" class="form-control" required></textarea>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="form-file">
                                                        <input type="file" class="form-file-input form-control" name="foto" accept="image/png, image/gif, image/jpeg">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <label for="iduser">Modul Kursus</label>
                                                <div class="input-group">
                                                    <span class="input-group-text">Upload</span>
                                                    <div class="form-file">
                                                        <input type="file" class="form-file-input form-control" name="modul" accept="application/pdf">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <tbody>
                                @foreach ($viewData as $x)
                                    <tr>
                                        ...
                                        <td>{{ $x->id_kursus }}</td>
                                        <td><a href="{{$x->contoh_game}}" target="_blank"> {{$x->nama_kursus}}</a><br>{{ $x->harga_kursus }}</td>
                                        <td>{{ $x->pengajar }}</td>
                                        <td>{{ $x->hari }}/ {{$x->jam}}</td>
                                        <td>{{ $x->materi_kursus }}
                                            @if($x->modul)
                                                <br><a href="{{ asset($x->modul) }}" target="_blank"> <i class="fa fa-file-pdf" style="font-size:48px;color:red"></i></a>
                                            @endif
                                        </td>
                                                    ...
                                                    <form action="update-kursus/{{ $x->id }}" method="POST"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="iduser">Materi Kursus</label>
                                                                    <textarea name="materi_kursus" id="materi_kursus" cols="30" rows="3" class="form-control" required>{{ $x->materi_kursus }}</textarea>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <label for="iduser">Foto Kursus</label>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <div class="input-group">
                                                                            ...
                                                                            <div class="form-file">
                                                                                <input type="file" class="form-file-input form-control" name="modul" accept="application/pdf"
                                                                                    value="{{ old('foto') }}">
                                                                                <input type="hidden" name="pathmodulnya" class="form-control-file"
                                                                                    value="{{ $x->modul }}">
                                                                            </div>
                                                                        </div>
                                                                    </div>
