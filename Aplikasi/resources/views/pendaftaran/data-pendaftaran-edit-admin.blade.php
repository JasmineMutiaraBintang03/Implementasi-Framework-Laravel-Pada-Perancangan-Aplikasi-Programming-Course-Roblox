                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-3 mb-4">
                                            ...
                                            <select name="pil1" id=""
                                                class="form-control">
                                                <option value="{{ $viewData->pil1 }}">{{ $viewData->pilihan1->nama_kursus }}</option>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3 mb-4">
                                            ...
                                            <select name="sekolah" class="form-control" id="">
                                                @foreach ($viewSekolah as $z2)
                                                @if ($viewData->sekolah == $z2->id)
                                                <option value="{{$viewData->sekolah}}">{{$z2->nama_sekolah}}</option>
                                                @endif
                                                @endforeach
