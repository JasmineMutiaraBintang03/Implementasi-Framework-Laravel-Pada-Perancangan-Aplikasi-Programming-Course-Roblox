                ...
                <div class="row my-4">
                    <div class="col">
                        <div class="text-end mt-2 mt-sm-0">
                            @if($viewData->smt6 != null && $viewData->smt6 != 0)
                                <p>Rata Rata Nilai {{ ($viewData->smt1+$viewData->smt2+$viewData->smt3+$viewData->smt4+$viewData->smt5+$viewData->smt6)/6 }}</p>
                            @else
                                <p>Rata Rata Nilai {{ ($viewData->smt1+$viewData->smt2+$viewData->smt3+$viewData->smt4+$viewData->smt5)/5 }}</p>
                            @endif
