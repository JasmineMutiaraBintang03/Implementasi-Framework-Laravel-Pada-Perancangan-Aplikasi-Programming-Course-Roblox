...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 09, 2023 at 02:53 AM
...
(6, '2022_12_14_131321_create_social_accounts_table', 1),
(7, '2022_12_14_143829_create_program_studis_table', 1),
(8, '2022_12_14_143946_create_sekolahs_table', 1),
(9, '2022_12_14_144008_create_timelines_table', 1),
(10, '2022_12_14_144036_create_pendaftarans_table', 1),
(11, '2022_12_14_144051_create_pembayarans_table', 1),
(12, '2022_12_14_144114_create_pengumuman_table', 1);
...
(1, 'PEMPSB00001', 'data pendaftar/20230100001/Prestasi1673879039-Formulir Pendaftaran-Cupiditate ex amet (1).pdf', 'Dibayar', 1, 150000, '2023-02-11', '2023-02-10', 1, '2023-02-09 00:22:51', NULL);
...
(1, '20230100001', 3, '92348927348', '72619873972094293', 'Inayah Fauziah', 'Perempuan', 'data pendaftar/20230100001/Pasfoto1673879039-WhatsApp Image 2023-01-05 at 14.13.39.jpeg', 'Purwakarta', '2023-02-09', 'Islam', 'emailinay@gmail.com', '238742342340', 'data pendaftar alamat', NULL, NULL, NULL, NULL, '2023', 1, 2, 'data pendaftar nama_ayah', 'data pendaftar nama_ibu', 'data pendaftar pekerjaan_ayah', 'data pendaftar pekerjaan_ibu', 'data pendaftar pendidikan_ayah', 'data pendaftar pendidikan_ibu', 'data pendaftar nohp_ayah', 'data pendaftar nohp_ibu', 'data pendaftar penghasilan_ayah', 'data pendaftar penghasilan_ibu', 'data pendaftar/20230100001/BerkasOrtu1673879039-Formulir Pendaftaran-Cupiditate ex amet.pdf', 1, 99, 92, 93, 94, 95, 96, 'data pendaftar/20230100001/BerkasSiswa1673879039-Formulir Pendaftaran-Cupiditate ex amet (1).pdf', 'path_prestasi', 'Selesai', '2023-02-09 07:22:51', '2023-02-09 00:22:51', NULL);
...
(1, 'PENGSB00001', '1', '2', 'LULUS', 1, 100, 100, 0, '2023-02-09 00:22:51', NULL);
...
(1, 1, 'Jasmine Mutiara Bintang', 'admin@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2023-02-09 00:22:51', NULL),
(2, 2, 'Jasmine Mutiara Bintang', 'admin@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2023-02-09 00:22:51', NULL),
(3, 3, 'Iam User', 'user@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2023-02-09 00:22:51', NULL);
...
CREATE TABLE `program_kursus` (
  ...
  `materi_kursus` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `program_kursus` (`id`, `id_kursus`, `nama_kursus`, `jenjang_kursus`, `foto_kursus`, `pengajar`, `jam`, `hari`, `contoh_game`, `harga_kursus`, `materi_kursus`, `modul`, `created_at`, `updated_at`) VALUES
(1, 'KRS001', 'PUZZLE GAME', 'Program 1', 'foto kursus/kursus1672487749-puzzle.jpg', 'Daffa Audya Pramana', '08.00 - 10.00 WIB', 'Selasa', 'https://www.roblox.com/games/9696171676/Guess-The-Picture', 'Rp.60.000', 'Dasar Dasar Pemrograman Lua, Konsep Dalam Pembuatan Game Puzzle, Logika Game Puzzle, Publish & Export Game', NULL, '2023-02-09 00:22:51', NULL),
(2, 'KRS002', 'FIGHTING GAME', 'Program 2', 'foto kursus/kursus1672488285-fighting.jpg', 'Daffa Audya Pramana', '09.00 - 12.00 WIB', 'Rabu', 'https://www.roblox.com/games/12209778293/Fighting-Game', 'Rp.50.000', 'Dasar Dasar Pemrograman Lua, Konsep Dalam Pembuatan Game Puzzle, Logika Game Puzzle, Publish & Export Game', NULL, '2023-02-09 00:22:51', NULL),
(3, 'KRS003', 'SPORT GAME', 'Program 3', 'foto kursus/kursus1672488306-sport.jpg', 'Daffa Audya Pramana', '09.00 - 13.00 WIB', 'Jumat', 'https://www.roblox.com/games/11744310885/My-Obby-Sports', 'Rp. 40.000', 'Dasar Dasar Pemrograman Lua, Sound and Background Sport Game, Basic Game Sport, Publish & Export Game', NULL, '2023-02-09 00:22:51', NULL),
(4, 'KRS004', 'EDUCATION GAME', 'Program 4', 'foto kursus/kursus1672488321-education.jpg', 'Daffa Audya Pramana', '12.00 - 14.00 WIB', 'Kamis', 'https://www.roblox.com/games/12093321567/Find-The-Button', 'Rp.30.000', 'Dasar Dasar Pemrograman Lua, Make a High School Game, Script Function, Publish & Export Game', NULL, '2023-02-09 00:22:51', NULL);
...
(1, '2303241', 'SMAN 3 Purwakarta', 'Purwakarta', 'Purwakarta', '2023-02-09 00:22:51', NULL);
...
CREATE TABLE `timeline` (
  ...
  `tgl_update` date NOT NULL DEFAULT '2023-02-09',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, '1', 'Bergabung', 'Membuat Akun baru', '2023-02-09', '2023-02-09 00:22:51', NULL),
(2, '2', 'Bergabung', 'Membuat Akun baru', '2023-02-09', '2023-02-09 00:22:51', NULL),
(3, '3', 'Bergabung', 'Membuat Akun baru', '2023-02-09', '2023-02-09 00:22:51', NULL);
...
(1, 'Jasmine Mutiara Bintang', 'admin@gmail.com', '2023-02-09 00:22:51', '$2y$10$epruJan0QTpXdlIxVYhzQur.KVvZzR4a.BtmmRl1nN232cpkK8NCi', 'Administrator', NULL, '2023-02-09 00:22:51', '2023-02-09 00:22:51'),
(2, 'Jasmine Mutiara Bintang', 'admin2@gmail.com', '2023-02-09 00:22:51', '$2y$10$t0Ig05GPZ2tlhg4DbNjG3euCbicl8YjcV5YwSxdkwjyToIuuIxXMe', 'Administrator', NULL, '2023-02-09 00:22:51', '2023-02-09 00:22:51'),
(3, 'Iam User', 'user@gmail.com', '2023-02-09 00:22:51', '$2y$10$PXWstfoOJkt8KkdURlvnYewRwnmHkHE9wgMNsvKnANjNHAlg0mCnq', 'Calon Peserta', NULL, '2023-02-09 00:22:51', '2023-02-09 00:22:51');
